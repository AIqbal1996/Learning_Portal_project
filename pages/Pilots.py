...
st.markdown('<h1 style="color: #E74C3C;">💻 Pilots</h1>', unsafe_allow_html=True)
#st.markdown("---")

try:
    # Read from local Pilots.xlsx file
    excel_file_path = "Pilots.xlsx"
    
    if not os.path.exists(excel_file_path):
        st.error("❌ Pilots.xlsx file not found!")
        st.stop()
    ...
    st.markdown("### 📊 Select the Pilots sheet below")
